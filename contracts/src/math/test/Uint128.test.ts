  ...
  describe('arithmetic', () => {
    ...
    describe('subU128', () => {
      ...
      test('should subtract with borrow', () => {
        const result = uint128Simulator.subU128(
          u128(MAX_UINT64 + 1n),
          u128(1n),
        );
        expect(result.low).toBe(MAX_UINT64);
    ...
    describe('rem', () => {
      ...
      test('should fail when remainder >= divisor', () => {
        uint128Simulator.overrideWitness('wit_divUint128', (context) => [
          context.privateState,
          {
            quotient: { low: 1n, high: 0n },
            remainder: { low: 10n, high: 0n },
          },
        ]);
  ...
  describe('utilities', () => {
    ...
    describe('isMultiple', () => {
      ...
      test('should handle large divisors', () => {
        expect(uint128Simulator.isMultiple(MAX_UINT128, MAX_UINT128)).toBe(
          true,
        );
    ...
    describe('isMultipleU128', () => {
      ...
      test('should check large U128 numbers', () => {
        expect(
          uint128Simulator.isMultipleU128(u128(MAX_UINT128), u128(1n)),
        ).toBe(true);
      });
      ...
      test('should fail when witness returns quotient * b + remainder != a', () => {
        ...
        expect(() =>
          uint128Simulator.isMultipleU128(u128(6n), u128(3n)),
        ).toThrow('failed assert: Uint128: division invalid');
      });
    });
    ...
    describe('min', () => {
      ...
      test('should handle max Uint<128>', () => {
        ...
        expect(uint128Simulator.min(MAX_UINT128, MAX_UINT128)).toBe(
          MAX_UINT128,
        );
      });
    ...
    describe('max', () => {
      ...
      test('should handle max Uint<128>', () => {
        ...
        expect(uint128Simulator.max(MAX_UINT128, MAX_UINT128)).toBe(
          MAX_UINT128,
        );
      });
