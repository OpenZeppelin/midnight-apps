...
import type {
  ...
  Math_DivResult,
  Witnesses,
} from '../artifacts/MockMath/contract/index.cjs'; // Adjust path to your generated artifacts
 ...
 * @returns An object implementing the Witnesses interface for MathContractPrivateState.
 */
export const MathWitnesses = (): Witnesses<MathContractPrivateState> => ({
  /**
