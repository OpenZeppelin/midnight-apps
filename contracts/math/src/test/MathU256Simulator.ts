...
import type { DivResultU256, U128, U256 } from '../artifacts/Index/contract/index.d.cts';
import {
    Contract,
    type Ledger,
    ledger,
...
export class MathU256Simulator
    ...
    public isMultiple(value: U256, divisor: U256): boolean {
        const result = this.contract.circuits.isMultiple(this.circuitContext, value, divisor);
        this.circuitContext = result.context;
        return result.result;
    }
}
