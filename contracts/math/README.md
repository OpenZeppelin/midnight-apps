...
```bash
pnpm add @midnight-dapps/math-contracts
```
...
} from '@midnight-dapps/math-contracts';
```

### Square Root Calculation

```typescript
import { sqrtBigint } from '@midnight-dapps/math-contracts';
...
```typescript
import { MathU64Witnesses } from '@midnight-dapps/math-contracts';
...
- `@midnight-dapps/compact` - Core Compact framework
