...
describe("Lunarswap", () => {
	...
	describe("addLiquidity", () => {
		describe("USDC/NIGHT pair", () => {
			...
			it("should add liquidity to existing USDC/NIGHT pair", () => {
				...
				const recipient = createEitherFromHex(LP_USER);
				const result1 = calculateLiquidityAmounts(
					2000n, // desired USDC
					1000n, // desired NIGHT
					0n, // reserve USDC
					0n, // reserve NIGHT
				...
				const result2 = calculateLiquidityAmounts(
					2000n, // desired USDC
					1000n, // desired NIGHT
		...
		describe("error handling", () => {
			...
			it("should handle multiple rapid liquidity additions", () => {
				...
				const result3 = calculateLiquidityAmounts(
					2000n, // desired USDC
					2000n, // desired NIGHT
	...
	describe("getAllPairLength", () => {
		...
		it("should track cumulative unique pairs creation", () => {
			...
			const result4 = calculateLiquidityAmounts(
				15000n, // desired USDC
				7000n, // desired FOO
				0n, // reserve USDC
				0n, // reserve FOO
			...
			const result5 = calculateLiquidityAmounts(
				9000n, // desired NIGHT
				11000n, // desired FOO
				0n, // reserve NIGHT
				0n, // reserve FOO
			...
			const result6 = calculateLiquidityAmounts(
				5000n, // desired DUST
				5000n, // desired FOO
				0n, // reserve DUST
				0n, // reserve FOO
			...
			const result7 = calculateLiquidityAmounts(
				5000n, // desired USDC
				2500n, // desired NIGHT
				reserveUSDC, // actual reserve USDC
				reserveNIGHT, // actual reserve NIGHT
