...
describe("swap", () => {
	...
	describe("swapExactTokensForTokens", () => {
		...
		let initialUsdcReserve: bigint;
		let initialNightReserve: bigint;
		...
		beforeEach(() => {
			...
			initialUsdcReserve = reserves[0];
			initialNightReserve = reserves[1];
		});
	...
	describe("Cross-Function Tests", () => {
		...
		it("should handle multiple swaps in sequence", () => {
			...
			const preReserves1 = lunarswap.getPairReserves(usdcCoin, nightCoin);
			const preUsdcReserve1 = preReserves1[0];
			const preNightReserve1 = preReserves1[1];
			lunarswap.swapExactTokensForTokens(
				swapUsdcCoin1,
				nightCoin,
				amountIn1,
