import type { CoinInfo, ContractAddress, Either, ZswapCoinPublicKey } from "@midnight-dapps/compact-std";
...
const ADMIN = "mn_shield-addr_test1yz95e4uu8j88t7vjvjnq8ywv9z7rg4dyvas98zhlktqtdhj600nqxqyja8d99chz8mmek4g4swsz6ldws3dlx9gzza96434w83kc8grj2umx4xe6"
...
const createEitherFromHex = (hexString: string): Either<ZswapCoinPublicKey, ContractAddress> => {
...
describe("ShieldedFungibleToken", () => {
	...
	const setup = () => {
		token = new ShieldedFungibleTokenSimulator(NONCE, "Test Token", "TEST", DOMAIN);
	};
	...
	describe("edge cases and error handling", () => {
		...
		it("should maintain state consistency", () => {
			...
			const coin2 = token.mint(recipient, 500n);
			const burnResult = token.burn(coin1, 300n);
			const coin3 = token.mint(recipient, 200n);
