...
export function getVersionInfo(): VersionInfo {
  ...
  const midnightNtwrkPackages: { [key: string]: string } = {
    ...
    '@midnight-ntwrk/midnight-js-indexer-public-data-provider': '3.2.0-rc.1',
    '@midnight-ntwrk/midnight-js-level-private-state-provider': '3.2.0-rc.1',
    '@midnight-ntwrk/midnight-js-network-id': '3.2.0-rc.1',
    '@midnight-ntwrk/midnight-js-testing': '2.0.2',
    '@midnight-ntwrk/midnight-js-types': '3.2.0-rc.1',
